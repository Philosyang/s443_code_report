...
```{r}
# shift PM2.5 by 24 rows = 1 day prediction
forecasting_pm2.5 = df2$PM2.5[25:length(df2$PM2.5)]
full_forecast_pm2.5 = append(forecasting_pm2.5, rep(0, 24))
df2$PM2.5 = full_forecast_pm2.5
```
...
```{r}
# shift PM2.5 by 24 rows = 1 day prediction
forecasting_pm2.5 = df3$PM2.5[25:length(df3$PM2.5)]
full_forecast_pm2.5 = append(forecasting_pm2.5, rep(0, 24))
df3$PM2.5 = full_forecast_pm2.5
```
...
```{r}
PM2.5_Residuals = b$PM2.5
hist(PM2.5_Residuals)
```
